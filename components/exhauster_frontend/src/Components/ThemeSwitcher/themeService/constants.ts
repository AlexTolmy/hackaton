...
const defaultLightThemeColorPalette = {
  /* Default colors */
  '--color-gray-f': '#ffffff',
  '--color-gray-1': '#fbfbfb',
  '--color-gray-2': '#f5f5f5',
...
const defaultDarkThemeColorPalette = {
  /* Default colors */
  '--color-gray-f': '#161b22',
  '--color-gray-1': '#111316',
  '--color-gray-2': '#21262c',
...
export default {
  [ColorPaletteType.Light]: defaultLightThemeColorPalette,
  [ColorPaletteType.Dark]: defaultDarkThemeColorPalette,
};
